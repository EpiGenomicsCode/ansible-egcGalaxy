...
if __name__ == '__main__':
    ...
    if options.input_format == 'gff':
        ...
        input_path = sort_chromosome_reads_by_index(options.input_fn)
    else:
    ...
    reader = csv.reader(openfile(input_path, 'rt'), delimiter='\t')
    if (options.gzip):
